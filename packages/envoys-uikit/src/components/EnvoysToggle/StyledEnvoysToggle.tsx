...
import { scales, EnvoysToggleProps, HandleProps, InputProps, ScaleKeys } from "./types";
...
const getScale =
  (property: ScaleKeys) =>
  ({ scale = scales.LG }: EnvoysToggleProps) => {
    return scaleKeyValues[scale][property];
  };

export const EnvoysStack = styled.div<HandleProps>`
  position: relative;
...
export const EnvoysInput = styled.input<InputProps>`
  height: 40px;
  left: 0;
  opacity: 0;
  position: absolute;
...
export const EnvoysLabel = styled.label<EnvoysToggleProps>`
